...
const OUTPUT_PATH = path.join(__dirname, "public/ogp.webp");
...
async function main() {
  console.log("Loading assets for default OGP...");
          ...
          // Main Card
          {
            ...
            props: {
              style: {
                ...
                padding: "54px",
                margin: "24px",
                width: "1152px", // 1200 - 24*2
                height: "582px", // 630 - 24*2
              ...
              children: [
                // Top area: TECH BLOG badge (Right Aligned)
                {
                  type: "div",
                  props: {
                ...
                // Center area: Site Title & Description
                {
                  type: "div",
                  props: {
                    style: {
                    ...
                    children: [
                      ...
                      },
                      {
                         ...
                         props: {
                           ...
                           children: "フロントエンドとTypeScriptを中心とした発信記録",
                         },
                      },
                    ],
                  },
                },
                // Bottom area: Brand Logo (Icon + SVG) - Center Aligned
                {
                  type: "div",
                  props: {
                    style: {
  ...
  console.log(`Generated default OGP: ${OUTPUT_PATH}`);
}
